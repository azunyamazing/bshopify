 ...
 * project does not install the package, prefer the JSDoc form generated by
 * `init` instead: a `// @ts-check` header plus a JSDoc annotation directly
 * above the default export — `@type {import("@bestfulfill/bshopify").RunnerConfigInput}`
