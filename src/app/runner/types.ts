 ...
 *
 * This is the type behind the editor hints for the config file: the
 * template generated by `init` references it via JSDoc
 * (`@type {import('@standhigher/bshopify').RunnerConfigInput}`), and
 * `defineConfig` accepts it for a Vite-style typed default export.
 */
